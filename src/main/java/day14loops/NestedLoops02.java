...
public class NestedLoops02 {
    public static void main(String[] args) {
        ...
        for (int i = 1 ; i<= row ; i ++){ // Distaki loop icin satir sayisi kadar calisir

            for (int k = 1 ; k <= column ; k++){ // icteki loop yan yana yazdigindan sutunlar icin sutun sayisi kadar calisir
                System.out.print("X ");
                 }
            System.out.println(); //satir yan yana yazdirildiktan sonra pointeri bir sonraki satira almak icin.
        }
