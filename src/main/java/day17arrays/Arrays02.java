...
public class Arrays02 {
    ...
    public static void main(String[] args) {
        //Ornek1 : Kullanicinin coklu data yi bir array e yerlestirebilmesi, istedigi zaman durdurabilmesi icin gereken kodu yaziniz


        /*
        1) Kullanicidan data almak icin Scanner oject olusturunuz
        ...
        4)Eleman ekleme islemini tekrar tekrar yapabilmeliyiz
         */
